...
*******************************************************************/
bool SerialInterface::openSyn(string serial_name, DWORD baud_rate, unsigned char parity, unsigned char byte_size, unsigned char stop_bits)
{
...
DWORD SerialInterface::readData(uint8_t *buffer,int length)
{
    DWORD writeSize=0;
...
DWORD SerialInterface::writeData(uint8_t *buffer,int length)
{
    DWORD writeSize=0;
